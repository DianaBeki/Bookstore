...
**Bookstore is a single Page web application developed using React and Redux. The application allows users to Add a book, Display books and delete a book from the book list.**
...
```sh
  cd my-folder
  git clone git@github.com:DianaBeki/bookstore.git
```

### To run the project

run npm start in VS Code terminal, to run via live server extension and see how the code works. 
<p align="right">(<a href="#readme-top">back to top</a>)</p>
